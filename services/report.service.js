...
const analysisReportFormat = {
  prodes(
    ...
    resultReportData[
      'urlGsLegend'
    ] = `${config.geoserver.geoserverBasePath}/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=30&HEIGHT=30&legend_options=forceLabels:on;forceTitles:off;layout:vertical;columns:2;fontSize:16&LAYER=${views.STATIC.children.CAR_VALIDADO.workspace}:CAR_VALIDADO_X_CAR_PRODES_X_USOCON`;
    ...
    resultReportData['urlGsImage3'] = `${
      ...
      resultReportData.property.gid
    }'&srs=EPSG:${config.geoserver.sridTerraMa}&format=image/png`;
