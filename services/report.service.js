...
setReportFormat = async function(reportData, views) {
  ...
  async getReportCarData(query) {
    ...
    try {
      ...
      const sql = `
            ...
            INNER JOIN public.${views.STATIC.children.MUNICIPIOS.table_name} munic ON
      ...
      if (propertyData) {
        ...
        return Result.ok(await setReportFormat(propertyData, views));
      }
    } catch (e) {
      return Result.err(e)
    }
