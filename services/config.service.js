  ...
  async getSynthesisConfig() {
    ...
    const synthesis = {
      visionslegends: [
        {
          title: `Estado`,
          url: `http://www.terrama2.dpi.inpe.br/mpmt/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=30&HEIGHT=30&legend_options=forceLabels:on&LAYER=${groupView.STATIC.children.MUNICIPIOS.workspace}:${groupView.STATIC.children.MUNICIPIOS.view}`
        },
        {
          title: `APP`,
          url: `http://www.terrama2.dpi.inpe.br/mpmt/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=30&HEIGHT=30&legend_options=forceLabels:on&LAYER=${groupView.STATIC.children.CV_AREA_APP.workspace}:${groupView.STATIC.children.CV_AREA_APP.view}`
        },
        {
          title: `Uso Antropizado`,
          url: `http://www.terrama2.dpi.inpe.br/mpmt/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=30&HEIGHT=30&legend_options=forceLabels:on&LAYER=${groupView.STATIC.children.CV_AREA_USO_ANTROPIZADO_DO_SOLO.workspace}:${groupView.STATIC.children.CV_AREA_USO_ANTROPIZADO_DO_SOLO.view}`
        },
        {
          title: `Reserva legal`,
          url: `http://www.terrama2.dpi.inpe.br/mpmt/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=30&HEIGHT=30&legend_options=forceLabels:on&LAYER=${groupView.STATIC.children.CV_AREA_RESERVA_LEGAL_NATIVA.workspace}:${groupView.STATIC.children.CV_AREA_RESERVA_LEGAL_NATIVA.view}`
        },
        {
          title: `Vegetação Nativa`,
          url: `http://www.terrama2.dpi.inpe.br/mpmt/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=30&HEIGHT=30&legend_options=forceLabels:on&LAYER=${groupView.STATIC.children.CV_AREA_VEGETACAO_NATIVA.workspace}:${groupView.STATIC.children.CV_AREA_VEGETACAO_NATIVA.view}`
        },
        {
          title: `Uso consolidado`,
          url: `http://www.terrama2.dpi.inpe.br/mpmt/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=30&HEIGHT=30&legend_options=forceLabels:on&LAYER=${groupView.STATIC.children.CV_AREA_USO_CONSOLIDADO.workspace}:${groupView.STATIC.children.CV_AREA_USO_CONSOLIDADO.view}`
        },
        {
          title: `CAR x DETER`,
          url: `http://www.terrama2.dpi.inpe.br/mpmt/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=30&HEIGHT=30&legend_options=forceLabels:on&LAYER=${groupView.DETER.children.CAR_X_DETER.workspace}:${groupView.DETER.children.CAR_X_DETER.view}`
        },
        {
          title: `CAR x PRODES`,
          url: `http://www.terrama2.dpi.inpe.br/mpmt/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=30&HEIGHT=30&legend_options=forceLabels:on&LAYER=${groupView.PRODES.children.CAR_X_PRODES.workspace}:${groupView.PRODES.children.CAR_X_PRODES.view}`
        },
        {
          title: `CAR x TI`,
          url: `http://www.terrama2.dpi.inpe.br/mpmt/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=30&HEIGHT=30&legend_options=forceLabels:on&LAYER=${groupView.DETER.children.CAR_DETER_X_TI.workspace}:${groupView.DETER.children.CAR_DETER_X_TI.view}`
        },
        {
          title: `Imóvel`,
          url: `http://www.terrama2.dpi.inpe.br/mpmt/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=30&HEIGHT=30&legend_options=forceLabels:on&LAYER=${groupView.STATIC.children.CAR_VALIDADO.workspace}:${groupView.STATIC.children.CAR_VALIDADO.view}`
        }
      ],
      propertyData: {
