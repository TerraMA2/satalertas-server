...
async function getAllTables() {
  try {
    ...
    throw new Error(msgError(__filename, 'getAllTables', e));
  }
}
...
async function getTableColumns(tableId) {
  try {
    ...
    await getInfocolumnsByTableName(
...
async function getInfocolumnsByTableName(tableName) {
  try {
    const options = {
      where: { tableName },
      include: [
...
async function updateTableInfoColums(editions) {
  try {
...
module.exports = ConfigService = {
  ...
  updateTableInfoColums,
  getInfocolumnsByViewId,
