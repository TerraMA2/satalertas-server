...
module.exports = function (reportData) {
  const carRegister = reportData.stateRegistry
      ? reportData.stateRegistry
      : reportData.federalRegistry;
  ...
  return {
    ...
    content: [
      ...
      reportData.images.fireSpotHistoryChart,
      {
        text: [
          {
            text: 'Figura 3 ',
      ...
      reportData.images.fireSpotDeforestationChart,
      {
        text: '',
        pageBreak: 'after',
      },
