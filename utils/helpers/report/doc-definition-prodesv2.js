    ...
    content: [
      ...
      },
      {
        text: [
          {
            text:
              'Trata-se de relatório técnico sobre desmatamentos ilegais, com ou sem uso de fogo'
              + ' identificados ' +
      ...
      },
      {
        text: [
          ...
          {
            text: `Mapa de Localização e do Perímetro do Imóvel, imagem PlanetScope de ${reportData.currentYear}.`,
            bold: false,
          },
        ],
        alignment: 'center',
      ...
      {
        text:
          'Os dados do PRODES, DETER e focos foram cruzados ' +
      ...
      {
        text:
          'As informações sobre o imóvel rural onde incidiu o desmatamento e' +
      ...
      {
        text: [
          'proibitivo de uso do fogo para limpeza e manejo de áreas conforme ' +
      ...
      {
        text:
          'Os dados do programa Queimadas possuem características distintas em ' +
          'relação aos dados do PRODES e DETER, pois os focos representados na ' +
          'forma de um ponto são a indicação do centro de um píxel de uma imagem ' +
          'de um dos satélites recebidos e processados pelo INPE. A quantidade ' +
          'de satélites pode variar ao longo do tempo e por este motivo as ' +
      ...
      },
      {
        text:
          ...
          `no período de ${reportData.formattedFilterDate.replace(
            'a',
            'até',
          )}. Na figura 08 é possível ` +
          'observar em imagem de satélite os focos de calor que incidiram na ' +
          'propriedade. Na figura 09 consta o gráfico com a série temporal de ' +
